        ...
        <div className="px-4 py-16 sm:px-16 flex flex-col justify-center items-center gap-16 max-w-full">
          ...
          >
            <CarouselContent className="flex gap-2">
              <CarouselItem className="hidden sm:block basis-full lg:basis-1/2">
                    ...
                    <div className="flex flex-col justify-between h-full p-4">
                      <div className="flex flex-col gap-4">
                        ...
                        <p className="font-normal text-sm text-stone-600">
                          ...
                          maiores fuga. Assumenda deserunt, blanditiis
                          quibusdam, necessitatibus, quaerat cum distinctio
                          ipsum animi nemo veniam dicta. Pariatur deleniti sit
                          aut commodi laudantium. Debitis neque culpa nesciunt
                          temporibus qui sit. Illum dignissimos odio aspernatur.
                          Cum suscipit a, ex illum eligendi mollitia, enim
                          asperiores, facere animi voluptas voluptatum.
                        </p>
                      </div>
              ...
              {Array.from({ length: numberOfPages }).map((_, pageIndex) => (
                <CarouselItem
                  key={pageIndex}
                  className="p-0 basis-full lg:basis-1/4 grid grid-rows-2 gap-2"
                >
                  {BeritaSeeder.slice(
                        ...
                        <div className="flex flex-col gap-8 p-4">
                          <div className="flex flex-col gap-4">
                            ...
                            <p className="font-normal text-sm text-stone-600">
                              ...
                              adipisicing elit. Assumenda eveniet atque, odio
                              molestiae voluptatum, placeat sint ipsam nisi
                              itaque harum quas dicta nostrum dolorem
                              consequuntur suscipit, voluptatibus velit et a.
                            </p>
                          </div>
                          <div className="flex justify-between items-center">
                            <p className="font-normal text-sm text-amber-500">
